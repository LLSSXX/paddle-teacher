Page({
  ...
  onLoad: function (options) {
    ...
    var that = this;
    wx.request({
      url: 'https://paddle-teacher.xyz/teacher_my/check_record/classroom_check_record/classroom_check_record_load',
      data: {
  ...
  search: function () {
    ...
    var that = this;
    wx.request({
      url: 'https://paddle-teacher.xyz/teacher_my/check_record/classroom_check_record/classroom_check_record_select',
      data: {
        college: JSON.stringify(college),
  ...
  button: function (e) {
    wx.navigateTo({
      url: '../classroom_check_record_detail/classroom_check_record_detail?sequence_number=' + e.currentTarget.dataset.sequence_number,
    })
  }
})