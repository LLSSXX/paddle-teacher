Page({
  ...
  onLoad: function (options) {
    ...
    wx.request({
      url: 'https://paddle-teacher.xyz/teacher_index/check_classroom/wait_check_classroom/wait_check_classroom_detail',
      data: {
      ...
      success: function (information) {
        that.setData({
          ...
          classroom: information.data.classroom,
  ...
  choose_pass: function () {
    ...
    wx.request({
      url: 'https://paddle-teacher.xyz/teacher_index/check_classroom/check_classroom_choose_pass',
      data: {
  ...
  choose_dispass: function () {
    ...
    wx.request({
      url: 'https://paddle-teacher.xyz/teacher_index/check_classroom/check_classroom_choose_dispass',
      data: {
        username: JSON.stringify(username),
        sequence_number: JSON.stringify(sequence_number)
      },
